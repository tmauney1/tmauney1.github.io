                ...
                <div class="row">
                    ...
                    <div id="reports">
                        ...
                        <ol>
                            ...
                            %>
                            <li>Category:
								<!--Displays total seats available by category-->
                        ...
                        <ol>
                            ...
                            %>
                            <li>Category:
							<!--Displays number of seats sold by category-->
                        ...
                        <ol>
                            ...
                            %>
                            <li>Category:
							<!--Displays total revenue by category-->
						...
						<!--Displays total revenue from all sales-->
                        <ol>
                            <%
                                try {
